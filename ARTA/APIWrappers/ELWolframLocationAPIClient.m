...
- (void)informationPodsRegardingTheLocation:(NSString *)location withBlock:(void (^)(NSArray *pods))block {
    ...
    NSDictionary *paramDictionary = [NSDictionary dictionaryWithObjectsAndKeys:location, kWolframGeneralInputParam, kWolframApiID, kWolframApiIDParam, [NSString stringWithFormat:@"%@", kWolframImageDatatype], kWolframResultsFormatParam, nil];
